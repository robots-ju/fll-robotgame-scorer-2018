...
describe('Robot Game 2018 specifications', function () {
    ...
    describe('Mission 03', function () {
        ...
        it('Cannot score both', function () {
            expect(FllScorer.getWarnings({
                m03_northeast: true,
                m03_ejected: true
            }).indexOf(FllScorer.warnings.m03_cannot_score_both)).not.toEqual(-1);
    ...
    describe('Mission 05', function () {
        ...
        it('Cannot score both', function () {
            expect(FllScorer.getWarnings({
                ...
                m05_gas_target: true,
                m05_gas_base: true
            }).indexOf(FllScorer.warnings.m05_cannot_score_both_gas)).not.toEqual(-1);
        });
        ...
        it('First step is required for all other', function () {
            expect(FllScorer.getWarnings({
                m05_gas_target: true
            }).indexOf(FllScorer.warnings.m05_gas_requirements_not_met)).not.toEqual(-1);
            ...
            expect(FllScorer.getWarnings({
                m05_water: true
            }).indexOf(FllScorer.warnings.m05_water_requirements_not_met)).not.toEqual(-1);
    ...
    describe('Mission 07', function () {
        ...
        it('Cannot score both', function () {
            expect(FllScorer.getWarnings({
                m07_completely: true,
                m07_partly: true
            }).indexOf(FllScorer.warnings.m07_cannot_score_both)).not.toEqual(-1);
    ...
    describe('Mission 08', function () {
        ...
        it('Cannot score both', function () {
            expect(FllScorer.getWarnings({
                m08_orange: true,
                m08_white: true
            }).indexOf(FllScorer.warnings.m08_cannot_score_multiple)).not.toEqual(-1);
    ...
    describe('Mission 12', function () {
        ...
        it('Cannot be more than 3 satellites', function () {
            expect(FllScorer.getWarnings({
                m12_satellites: 4
            }).indexOf(FllScorer.warnings.m12_max_value_exceeded)).not.toEqual(-1);
    ...
    describe('Mission 13', function () {
        ...
        it('Cannot score both', function () {
            expect(FllScorer.getWarnings({
                m13_orange: true,
                m13_white: true
            }).indexOf(FllScorer.warnings.m13_cannot_score_multiple)).not.toEqual(-1);
    ...
    describe('Mission 14', function () {
        ...
        it('Maximums', function () {
            expect(FllScorer.getWarnings({
                m14_center: 3
            }).indexOf(FllScorer.warnings.m14_max_combinations_exceeded)).not.toEqual(-1);
    ...
    describe('Mission 15', function () {
        ...
        it('Cannot score both', function () {
            expect(FllScorer.getWarnings({
                m15_target: true,
                m15_planet: true
            }).indexOf(FllScorer.warnings.m15_cannot_score_multiple)).not.toEqual(-1);
    ...
    describe('Penalties', function () {
        ...
        it('Cannot be more than 6 penalties', function () {
            expect(FllScorer.getWarnings({
                penalties: 7
            }).indexOf(FllScorer.warnings.too_many_penalties)).not.toEqual(-1);
